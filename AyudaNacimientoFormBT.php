...
?>
<script language="javascript"  src="./js/AyudaNacimientoBT.js"></script>
<h2><img src="images/document_layout.png" width="32" height="32">Ayuda por Nacimiento</h2><hr>
...
<label class="control-label">C.I. Otro Prog.:</label>
