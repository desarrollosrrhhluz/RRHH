...
<br><br>Por medio de la presente informo el nacimiento de mi hijo '.strtoupper(trim($fila['nombres'])).' cuya fecha de nacimiento fue el dia '.$fila['fe_nacimiento'].' numero de acta '.$fila['acta'].', por la cual solicito me conceda el beneficio de bonificación de conformidad a lo establecido en la PRIMERA CONVENCIÓN COLECTIVA ÚNICA DEL SECTOR UNIVERSITARIO.
<br><br>
