...
?>
<script language="javascript"  src="./js/ConsultaPermisoBT.js"></script>
<h2><img src="images/document_layout.png" width="32" height="32">Consulta Permiso</h2><hr>


<div id="div_form_fam" >

<input name="cedula_trabajador_permiso" id="cedula_trabajador_permiso" type="hidden" value="<?php echo $ci; ?>"  title="Ej:17896358" pattern="[0-9]+"/>
